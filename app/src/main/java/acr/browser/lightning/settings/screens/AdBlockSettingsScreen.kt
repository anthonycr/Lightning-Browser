...
fun AdBlockSettingsScreen(
    ...
    hostsFileUpdater: HostsFileUpdater,
    onUp: () -> Unit
) {
    val presenter: SettingsFrameworkPresenter = viewModel(
        ...
        factory = SettingsFrameworkPresenter.Factory(
            settingsFrameworkState = {
                SettingsFrameworkState(
                    resourceProvider.stringResource(R.string.settings_adblock),
                    content = listOf(
                        ToggleState(
                        ...
                        if (BuildConfig.FULL_VERSION) {
                            ClickableState(
                                ...
                                summary = {
                                    userPreferencesDataStore.selectedHostsSource()
                                        .toSummary(resourceProvider)
                                },
                                onClick = ClickableOnClick.ItemSelector(
                                    ...
                                    selected = {
                                        HostsSourcePreference.entries.indexOf(
                                            userPreferencesDataStore.hostsSource.get()
                                        )
                                    },
                                    onSelected = { index ->
                                        val updatedPreference = HostsSourcePreference.entries[index]
                                        when (updatedPreference) {
                                            ...
                                            HostsSourcePreference.LOCAL -> ClickableOnClick.FileChooser(
                                                ...
                                                onSelected = { uri ->
                                                    val file =
                                                        uri?.let {
                                                            hostsFileUpdater.readTextFromUri(
                                                                it
                                                            )
                                                        }
                                                    if (file == null) {
                                                        ...
                                                        ClickableOnClick.Action {
                                                            ...
                                                            userPreferencesDataStore.hostsLocalFile.set(
                                                                file.path
                                                            )
                                            ...
                                            HostsSourcePreference.REMOTE -> ClickableOnClick.Input(
                                                ...
                                                currentValue = {
                                                    userPreferencesDataStore.hostsRemoteFile.get()
                                                        .orEmpty()
                                                },
                                                ...
                                                onValueUpdated = { value ->
                                                    ...
                                                    if (url == null) {
                                                        ...
                                                        ClickableOnClick.Action {
                                                            ...
                                                            userPreferencesDataStore.hostsRemoteFile.set(
                                                                value
                                                            )
                                                        }
                                                    }
                            ...
                            ClickableState(
                                ...
                                title = resourceProvider.stringResource(R.string.block_ad_source),
                                summary = {
                                    resourceProvider.stringResource(R.string.block_ads_upsell_source)
                                },
                        ...
                        ClickableState(
                            ...
                            summary = {
                                resourceProvider.stringResource(R.string.block_ad_remote_refresh_frequency_description)
                            },
...
private fun HostsSourceType.toSummary(resourceProvider: ResourceProvider): String = when (this) {
    ...
    is HostsSourceType.Local -> resourceProvider.stringResource(
        R.string.block_source_local_description,
        file.path
    )

    is HostsSourceType.Remote -> resourceProvider.stringResource(
        R.string.block_source_remote_description,
        httpUrl
    )
}
