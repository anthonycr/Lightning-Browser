                    ...
                    content = listOf(
                        ...
                        ClickableState(
                            ...
                            onClick = ClickableOnClick.ItemSelector(
                                ...
                                selected = {
                                    TEXT_ENCODINGS.indexOf(userPreferencesDataStore.textEncoding.get())
                                },
                                onSelected = {
                        ...
                        ClickableState(
                            ...
                            onClick = ClickableOnClick.ItemSelector(
                                ...
                                selected = { RenderingMode.entries.indexOf(userPreferencesDataStore.renderingMode.get()) },
                                onSelected = {
                                    ClickableOnClick.Action {
                        ...
                        ClickableState(
                            ...
                            onClick = ClickableOnClick.ItemSelector(
                                ...
                                selected = {
                                    SearchBoxDisplayChoice.entries.indexOf(userPreferencesDataStore.urlBoxContentChoice.get())
                                },
                                onSelected = {
                                    ClickableOnClick.Action {
