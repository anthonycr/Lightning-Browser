...
class AssetsHostsDataSource @Inject constructor(
    ...
    /**
     * Reads through a hosts file and extracts the domains that should be redirected to localhost
     * (a.k.a. IP address 127.0.0.1). It can handle files that simply have a list of host names to
     * block, or it can handle a full-blown hosts file. It will strip out comments, references to
     * the base IP address and just extract the domains to be used.
     *
